...
static void printQr(const QrCode &qr) {
	...
	for (int y = -border; y < qr.getSize() + border; y++) {
		for (int x = -border; x < qr.getSize() + border; x++) {
            std::cout << (qr.getModule(x, y) ? "\033[33;47m  \033[0m" : "  ");
		}
		std::cout << std::endl;
	}
	std::cout << std::endl;
...
//             int b;
//             std::cin >> b;
//             data.push_back(static_cast<uint32_t>(b));
//             isAscii &= 0 < b && b < 128;
//         }

//         // Read encoding parameters
//         int errCorLvl, minVersion, maxVersion, mask, boostEcl;
//         std::cout << "Input errCorLvl: " << std::endl;
//         std::cin >> errCorLvl;
//         std::cout << "Input minVersion: " << std::endl;
//         std::cin >> minVersion;
//         std::cout << "Input maxVersion: " << std::endl;
//         std::cin >> maxVersion;
//         std::cout << "Input mask: " << std::endl;
//         std::cin >> mask;
//         std::cout << "Input boostEcl: " << std::endl;
//         std::cin >> boostEcl;
...
//             std::string white = "\033[33;47m  \033[0m";
